################### Identifying candidate genes with GFF file INTSAMPLES #######################
...
setwd ("/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Filtro_LOG_PO_FST_intsamples")
...
bayescan_and_pcadapt= read.table("/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Filtro_LOG_PO_FST_intsamples/outliers_comunes_intSamples_1_100_K=8_fst_statisc.txt")
...
write.table(OUTLIERS_filtred_LOGPO_FST, "outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=8_.txt", sep="\t", quote=FALSE)
...
cd /Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Filtro_LOG_PO_FST_intsamples

vcftools --vcf intSample.plilfordi_filter_minalle2_maxalle2_MAF005_Q30_minDP10_maxD50_maxMISS075.vcf --positions outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=8_positions.txt --recode --recode-INFO-all --out outliers_filtred_LOGPO_FST_comunes_bayescan_pcadapt_intsamples_withoutLD_1_100_K=8

grep -v # outliers_filtred_LOGPO_FST_comunes_bayescan_pcadapt_intsamples_withoutLD_1_100_K=8.recode.vcf | wc -l
#222
