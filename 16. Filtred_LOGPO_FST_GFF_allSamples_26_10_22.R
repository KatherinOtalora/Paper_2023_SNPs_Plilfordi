################### Identifying candidate genes with GFF file ALLSAMPLES #######################
...
setwd ("/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Filtro_LOGPO_FST_allsamples")
...
bayescan_and_pcadapt= read.table("/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Filtro_LOGPO_FST_allsamples/outliers_comunes_allSamples_0.90_1_100_K=15_fst_statisc.txt")
...
write.table(OUTLIERS_filtred_LOGPO_FST, "outliers_filtred_LOGPO_FST_allsamples_withoutLD_1_100_K=15_.txt", sep="\t", quote=FALSE)
...
cd /Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Filtro_LOGPO_FST_allsamples

vcftools --vcf allSample.plilfordi_filter_minalle2_maxalle2_MAF005_Q30_minDP10_maxD50_maxMISS090.vcf --positions outliers_filtred_LOGPO_FST_allsamples_withoutLD_1_100_K=15_positions.txt --recode --recode-INFO-all --out outliers_filtred_LOGPO_FST_comunes_bayescan_pcadapt_allSamples_withoutLD_0.90_1_100_K=15

grep -v # outliers_filtred_LOGPO_FST_comunes_bayescan_pcadapt_allSamples_withoutLD_0.90_1_100_K=15.recode.vcf | wc -l
#18
