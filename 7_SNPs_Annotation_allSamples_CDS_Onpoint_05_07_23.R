################### Identifying candidate genes ONPOINT #######################
...
SNP_file <- "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/names_outliers_filtred_LOGPO_FST_allsamples_withoutLD_1_100_K=15.txt"
...
write.table(SNPs_with_annotations.df,
            file = "Output_allsamples_anotacion.tsv",
            fileEncoding = "UTF-8",
            sep = "\t",
            row.names = FALSE)
...
output_name_1 <- "Output_allsamples_anotacion_filtredgenes.tsv" 
output_name_2 <- "Output_allsamples_anotacion_filtredCDS.tsv"
...
#Se hizo solo con el archivo de GENES por que con el de CDS no salio nada
SNP_file_1 <- "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_allsamples/Output_allsamples_anotacion_filtredgenes.tsv"
...
write.table(z,
            file = "annotation_outliers_filtred_LOGPO_FST_allsamples_withoutLD_1_100_K=15.tsv",
            fileEncoding = "UTF-8",
            sep = "\t",
            row.names = FALSE)
#Al outut que salio la columna attribute le elimino las palabras ID= y ;gene_type=protein_coding para quedarme solo con el nombre de la proteina 
...
....................................................................................................
################################ Anotacion con No_coding gff #########################
# Reading Definicion de  los non_coding_RNAs( se le quito el ### ENTRE DATOS para  que se pueda hacer LA ANOTACION)
...
output_name_3 <- "Output_allsamples_anotacion_lncRNA.tsv" 
...
SNP_file_protein <- "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_allsamples/annotation_outliers_filtred_LOGPO_FST_allsamples_withoutLD_1_100_K=15.tsv"
...
# Exporting SNPs with annotations to tab-separated value (.tsv) file ===========
write.table(z,
            file = "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_allsamples/annotation_GO_outliers_filtred_LOGPO_FST_allsamples_withoutLD_1_100_K=15.tsv",
            fileEncoding = "UTF-8",
            sep = "\t",
            row.names = FALSE)
#Al outut que salio la columna attribute le elimino las palabras ID= y ;gene_type=protein_coding para quedarme solo con el nombre de la proteina 
...
###################################### DEINIFICION DE GO #####################################
######################### No hay DEFINICION DE GO porque no tienen CDS  ######################
