...
SNP_file <- "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/names_outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=8.txt"
...
write.table(SNPs_with_annotations.df,
            file = "Output_intsamples_anotacion.tsv",
            fileEncoding = "UTF-8",
            sep = "\t",
            row.names = FALSE)
...
output_name_1 <- "Output_intsamples_anotacion_filtredgenes.tsv" 
output_name_2 <- "Output_intsamples_anotacion_filtredCDS.tsv"
...
SNP_file_1 <- "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/Output_intsamples_anotacion_filtredCDS.tsv"
...
write.table(z,
            file = "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/CDS_annotation_outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=8.tsv",
            fileEncoding = "UTF-8",
            sep = "\t",
            row.names = FALSE)
#Al outut que salio la columna attribute le elimino las palabras ID= y ;gene_type=protein_coding para quedarme solo con el nombre de la proteina 
...
SNP_file_2 <- "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/Output_intsamples_anotacion_filtredgenes.tsv"

# Reading SNPs con su anotacion del gff y editados (sin ID= y ;gene_type=protein_coding)
SNPs_2.df <- read.delim(
  SNP_file_2,
  header = T, sep="\t"
)
#No es necesario nombrar los colnames
...
# Exporting SNPs with annotations to tab-separated value (.tsv) file ===========
write.table(z,
            file = "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/GENE_annotation_outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=8.tsv",
            fileEncoding = "UTF-8",
            sep = "\t",
            row.names = FALSE)
#Al outut que salio la columna attribute le elimino las palabras ID= y ;gene_type=protein_coding para quedarme solo con el nombre de la proteina 
...
output_name_3 <- "Output_intsamples_anotacion_lncRNA.tsv" 
...
SNP_file_protein <- "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/CDS_annotation_outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=8.tsv"
...
# Exporting SNPs with annotations to tab-separated value (.tsv) file ===========
write.table(z,
            file = "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/CDS_annotation_GO_outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=8.tsv",
            fileEncoding = "UTF-8",
            sep = "\t",
            row.names = FALSE)
#Al outut que salio la columna attribute le elimino las palabras ID= y ;gene_type=protein_coding para quedarme solo con el nombre de la proteina 
...
SNP_file_protein <- "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/GENE_annotation_outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=8.tsv"
...
# Exporting SNPs with annotations to tab-separated value (.tsv) file ===========
write.table(z,
            file = "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/GENE_annotation_GO_outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=8.tsv",
            fileEncoding = "UTF-8",
            sep = "\t",
            row.names = FALSE)
#Al outut que salio la columna attribute le elimino las palabras ID= y ;gene_type=protein_coding para quedarme solo con el nombre de la proteina 
...
SNP_file_GO <- "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/CDS_annotation_GO_outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=8.tsv"
...
# Reading Definicion de las proteinas ( se le quito el P1 o P2,3,4,5,6,7,8,9 del final del nombre de cada proteina para el merge en .txt)
GO_def_file <- "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/gProfiler_pmuralis_06-07-2023_11-44-00__intersections_intsamples_onpoint.csv"
...
# Exporting SNPs with annotations to tab-separated value (.tsv) file ===========
write.table(z,
            file = "/Users/katherin_otalora/Documents/GFF_Genome_Plilfordi/Anotacion_intsamples/CDS_annotation_term_id_GO_outliers_filtred_LOGPO_FST_intsamples_withoutLD_1_100_K=10.tsv",
            fileEncoding = "UTF-8",
            sep = "\t",
            row.names = FALSE)
